        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-20 gap-[60px]">
          <div className="px-6">
            ...
            <p className="text-white text-[15px] leading-[25px] pb-[10px] lg:pb-5 lg:text-[24px] lg:leading-[30px] text-center lg:text-start">
              None. We’re good at ads, so we’ll stick with ads. Other agencies will try and hand out
              an entire menu of services for you to choose from, but we’ll give you a single option
              that will catapult your business due to the quality of service provided. We believe
              that focusing on our craft will allow us to provide exceptional results for our
              clients while not overpromising multiple services that may not meet our standards.
            </p>
          ...
          <div className=" lg:mx-0  h-full">
            <img src={img} className="w-full z-20 relative max-w-[246px] lg:max-w-[421px]" alt="" />
          </div>
        </div>
      </div>
    </div>
