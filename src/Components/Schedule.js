              ...
              <div class="card max-w-[506px]">
                ...
                <div class="card-body pt-0 items-center text-center">
                  ...
                  <span className="text-[16px] text-start leading-[26px] text-[#404040] pb-[20px] lg:pb-7">
                    Everything you need to know about working with Adverlo will be explained in this
                    call with our founder. We will be able to have a clear understanding of the
                    goals you want to be accomplished for your ad campaigns. During this call, you
                    will be shown case studies of the different successes Adverlo has created for
                    its clients.
                  </span>
                  <span className="text-[16px] text-start leading-[26px] text-[#404040]">
                    Find a time on the calendar that works for you, so you’ll be able to start your
                    adventure with Adverlo.
                  </span>
                </div>
              </div>
            </div>
